...
<div id="wrapper">
	...
	<div id="main">
		...
		<div id="content">
		<h2>Aggiorna I Tuoi Dati Nel Sito</h2><br>
		<?php
		//----------------------------------------------------------------------------
		...
		if ( MySQL_select_db ("Cuofano_ECommerce", $ServerSQL) )
		{
			...
			{	$riga = MySQL_fetch_array($ris);
				...
				{	echo  "<form  action='UpDateUtente.php' method='POST'>".
						...
						"<TR><TD>Nome</TD>		<TD>". $riga ['NomeUtente'] ."</TD></TR>".
						"<TR><TD>Cognome</TD>	<TD>". $riga ['CognomeUtente'] ."</TD></TR>".
						...
						"<TR><TD>       </TD><TD><INPUT TYPE='submit'  Id='Bottone' VALUE='Aggiorna'></TD></TR>".
						"</TABLE>".
						"</FORM>";
				}
			}
