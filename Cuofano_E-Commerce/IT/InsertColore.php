...
<HTML>
<HEAD>
	<TITLE>Inserimento Colore in Cuofano_ECommerce</TITLE>
	<!-- Style -->
...
<fieldset>
     ...
     <legend>Inserimento Di Un Nuovo Colore</legend>
	...
	<a href="InsertCategoriaForm.php">Inserisci Altro Colore</a><br>
