	...
	<div id="main">
		...
		<div id="content">
			...
			{	
					...
					{	
						...
						if ($riga)
						{
							echo	"<TABLE>".
									...
									echo "<TR><TD ALIGN='center'><a href='Articolo.php?NomeArticolo=".$riga['NomeArticolo']."'><img style='width: 100px;border: 2px dashed;' src='" . $riga['Immagine'] . "'/></a></TD><TD ALIGN='center'>".$riga['NomeArticolo']."</TD><TD ALIGN='center'>".$riga['NCopie']."</TD><TD ALIGN='center'>".$riga['NomeTaglia']."</TD><TD ALIGN='center'>".$riga['PrezzoArticolo']." &#8364 </TD><TD ALIGN='center'>".$riga['NomeSconto']."</TD><TD ALIGN='center'><a href='DelArticolo.php?Comp=1&IdCompra=".$riga['IdCompra']."'>Elimina</a></TD></TR>";
							...
							echo  "<TR><TD>&nbsp</TD><TD>&nbsp</TD><TD>&nbsp</TD><TD><strong>TOTALE:</strong></TD><TD ALIGN='center'>". $Totale ." &#8364</TD></TR>";
							echo  "<TR><TD>&nbsp</TD><TD>&nbsp</TD><TD>&nbsp</TD><TD>&nbsp</TD><TD>&nbsp</TD><TD>&nbsp</TD><TD ALIGN='center'><a href='ConvOrdini.php'><INPUT TYPE='button' align='right' Id='Bottone' VALUE='Acquista'></a></TD></TR>";
							echo  "</TABLE>";
							echo  "<h2>//##ATTENZIONE##\\\ <br> NON e`settato nessun metedo di pagamento, dunque la richiesta d`acquisto aggiornera`solo lo stato del carrello.</h2>";
				...
				{
					echo "<br><br><br><h2 align='center'> Il Carello e`<strong>VUOTO!</strong> </h2>";
				}
			}
			?>
    	</div> <!-- #content -->
