...
<div id="cop" style="background: url(../img/Slider8.png); background-size:100% auto; background-attachment:fixed;">
	...
	<div class="caption">
		<p>NUOVA <a href="Catalogo.php">Collezione 2014!</a></b></p>
	    <h2>Felpe Belle</h2>
			...
			{	
				...
				{	
					...
					if ($riga)
					{
						...
						$Totale = $riga['Totale'];
						echo	"<TABLE>".
								"<tr><th>Foto</th><th>Articolo</th><th>Quantita`</th><th>Taglia</th><th>Prezzo</th><th>Sconto</th><th>Importo</th></tr>";
						...
						echo  "<TR><TD>&nbsp</TD><TD>&nbsp</TD><TD>&nbsp</TD><TD>&nbsp</TD><TD>&nbsp</TD><TD ALIGN='center'><strong>TOTALE:</strong></TD><TD ALIGN='center'>". $Totale ." &#8364</TD></TR>";
						echo  "</TABLE>";
					}
					else
					{
						echo "<br><br><br><h2 align='center'>Esattamente come ci sei arrivato qui?</h2>";
					}		
				}
				else
				{
