					...
					{	
						...
						if ($riga)
						{
							echo "<h2>". $riga['NomeCategoria'] .' '.$riga['NomeArticolo']."</h2><br>".
								 ...
								 "<TABLE>".
								 "<TR><TD>Prezzo: </TD><TD>".$riga['PrezzoArticolo']." &#8364 </TD></TR>".
								 "<TR><TD>Sconto: </TD><TD>".$riga['NomeSconto']."</TD></TR>".
								 "<TR><TD>Colore: </TD><TD>".$riga['NomeColore']."</TD></TR>".
								 "<TR><TD>Taglia: </TD><TD>".$riga['NomeTaglia']."</TD></TR>".
								 "<TR><TD>Materiale: </TD><TD>".$riga['NomeMateriale']."</TD></TR>".
								 "<TR><TD>Disponibilita`: </TD><TD>".$riga['NDisp']."</TD></TR>".
								  "<TR><TD>&nbsp;</TD><TD>&nbsp;</TD></TR>";
							echo "<TR><TD>Quantita`: </TD><TD><SELECT NAME='Quantita' ID='Quantita'>".
								 "<OPTION VALUE=' '> </OPTION>";
								 $N = $riga ['NDisp'];
								 for ($I = 0; $I <= $N ;$I++)
								 {	
							...
							echo "</SELECT></TD><TR><TD>Aggiungi a</TD>".
								 "<TD><INPUT TYPE='button'  Id='Bottone' VALUE='Lista Desideri' onclick='getListaDesideri()'></TD>".
								 "<TD><INPUT TYPE='button'  Id='Bottone' VALUE='Carrello' onclick='getCarrello()'></a></TD></TR>";
