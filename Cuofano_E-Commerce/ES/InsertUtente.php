...
<div id="wrapper">
	...
	<?php
		...
		{	
			$sql = "INSERT INTO Utente (NomeUtente, CognomeUtente, EMail, Citta, Provincia, Indirizzo, Password, Privilegi) VALUES ('". $_REQUEST['NomeUtente'] ."', 
			'".$_REQUEST['CognomeUtente'] . "',
			'".$_REQUEST['EMail'] . "',
			'".$_REQUEST['Citta'] . "',
			'".$_REQUEST['Provincia'] . "',
			'".$_REQUEST['Indirizzo'] . "',
			...
			if ( MySQL_query ($sql) ) 
			{
				print ("Usuario (".$_REQUEST['NomeUtente'].") insertado.<br><br><br>" );
				print ("*Confirme su inscripci&ograve;n a trav&egrave;s de e-mail.<br>" );
			}
		}
	    else
