...
<HTML>
<HEAD>
	<TITLE>Poner Articulo in Cuofano_ECommerce</TITLE>
	<!-- Style -->
...
<fieldset>
     ...
     <legend>Poner Nuevo Articulo</legend>
	...
	print "</pre>";
		...
		{	
			...
			'".$_REQUEST['IdSconto'] . "')" ;
			if ( MySQL_query ($sql) ) 
				print ("Articulo  (".$_REQUEST['NomeArticolo'].") Insertado.<br>" );
		}
	    else
	...
	<a href="InsertArticoloForm.php">Poner Otro Articulo</a><br>
