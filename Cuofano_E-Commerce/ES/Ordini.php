		...
		<div id="content">
			...
			{	
				...
				{	
					...
					echo "<br><h2 align='center'> NO hay Pedidos en espera de confirmaci&oacute;n. </h2>";
				}
			}
			//Spedizioni
			if ($db)
			{	
				...
				{	
					...
					echo "<br><h2 align='center'>  NO hay Env&iacute;o en espera de confirmaci&oacute;n. </h2>";
				}	
			}
			//Storico Ordini
			if ($db)
			{	
				...
				{	
					...
					echo "<br><h2 align='center'> NO hay Pedidos ya entregados. </h2>";
				}	
			}
			?>
    	</div> <!-- #content -->
