...
<HTML>
<HEAD>
	<TITLE>Poner Material in Cuofano_ECommerce</TITLE>
	<!-- Style -->
...
<fieldset>
     ...
     <legend>Poner Nuevo Material</legend>
	...
	<?php
		...
		{	
			...
			if ( MySQL_query ($sql) ) 
				print ("<p>Material ( ".$_REQUEST['NomeMateriale'] .") posto.</p><br>" );
		}
	    else
	...
	<a href="InsertMaterialeForm.php">Poner Otro Material</a><br>
