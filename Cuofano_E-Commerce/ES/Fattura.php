			...
			{	
				...
				{	
					...
					if ($riga)
					{
						...
						$Totale = $riga['Totale'];
						echo	"<TABLE>".
								"<tr><th>Foto</th><th>Articulo</th><th>Cantidad</th><th>Tama&ntilde;o</th><th>Precio</th><th>Descuento</th><th>Cuenta</th></tr>";
					...
					{
						echo "<br><br><br><h2 align='center'>Exactamente c&ograve;mo has llegado hasta aqu&igrave;?</h2>";
					}		
				}
				else
				{
