...
<div id="wrapper">
	...
	<div id="main">
		...
		<div id="content">
			...
			?>
			<h2>Poner Nuevo Art&igrave;culo</h2>
			 <!--                 METHOD="get"                              -->
			...
			<TR><TD>Art&igrave;culo</TD><TD><INPUT TYPE="text"   NAME ="NomeArticolo"></TD></TR>
			<TR><TD>Tama&ntilde;o   </TD><TD><SELECT NAME="IdTaglia">
					<OPTION VALUE=' '> </OPTION>
					<?php
					if ($db)
			...
			<TR><TD>Precio</TD><TD><INPUT TYPE="text"   NAME ="PrezzoArticolo"></TD></TR>
			<TR><TD>Disponibilidad</TD><TD><INPUT TYPE="number"NAME ="NDisp"></TD></TR>
			...
			<TR><TD><input type="hidden" name="MAX_FILE_SIZE" value="3000000" />Imagen*</TD><TD><input name="userfile" type="file" /></TD></TR>
			
			
			<TR><TD>Material   </TD><TD><SELECT NAME="IdMateriale">
					<OPTION VALUE=' '> </OPTION>
					<?php
					if ($db)
			...
			<TR><TD>Color   </TD><TD><SELECT NAME="IdColore">
					<OPTION VALUE=' '> </OPTION>
					<?php
					if ($db)
			...
			<TR><TD>Descuento   </TD><TD><SELECT NAME="IdSconto">
					<OPTION VALUE=' '> </OPTION>
					<?php
					if ($db)
			...
			<TR><TD>       </TD><TD><INPUT TYPE="submit"  Id="Bottone" VALUE="Poner"></TD></TR>
			</TABLE>
			</FORM>
    	</div> <!-- #content -->
