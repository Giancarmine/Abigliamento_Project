...
<div id="wrapper">
	...
	<div id="main">
		...
		<div id="content">
			...
			<fieldset style="width: 200px; margin:0 auto; border: 2px groove threedface; margin-top: 10%;">
		    <legend>LogIn E-Commerce</legend>
			
			<FORM NAME="LogIN" METHOD="Post" ACTION="../Access.php">
				<TABLE>
					<tr><th style="text-align: left;">E-Mail</th></tr><tr><td><INPUT TYPE="text" NAME="Mail"></td></tr>
					<tr><th style="text-align: left;">Contrase&ntilde;a</th></tr><tr><td><INPUT TYPE="password" NAME="Pwd"></td></tr>
					<tr><td><a href="NewAccount.php">Registrar</a></td><td><INPUT TYPE="submit" Value="registrarse"></td></tr>
				</table>
			</FORM>
			</fieldset>
    	</div> <!-- #content -->
