...
<div id="wrapper">
	...
	<div id="main">
		...
		<div id="content">
		<h2>actualizar Sus datos en el Sitio</h2><br>
		<?php
		//----------------------------------------------------------------------------
		...
		if ( MySQL_select_db ("Cuofano_ECommerce", $ServerSQL) )
		{
			...
			{	$riga = MySQL_fetch_array($ris);
				...
				{	echo  "<form  action='UpDateUtente.php' method='POST'>".
						...
						"<TR><TD>Nombre</TD>		<TD>". $riga ['NomeUtente'] ."</TD></TR>".
						"<TR><TD>Apellido</TD>	<TD>". $riga ['CognomeUtente'] ."</TD></TR>".
						...
						"<TR><TD>       </TD><TD><INPUT TYPE='submit'  Id='Bottone' VALUE='Actualizar'></TD></TR>".
						"</TABLE>".
						"</FORM>";
				}
			}
