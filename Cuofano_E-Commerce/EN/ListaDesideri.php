				...
				{	
					...
					if ($riga)
					{
						echo	"<TABLE>".
								...
								echo "<TR><TD ALIGN='center'><a href='Articolo.php?NomeArticolo=".$riga['NomeArticolo']."'><img style='width: 100px;border: 2px dashed;' src='" . $riga['Immagine'] . "'/></a></TD><TD ALIGN='center'>".$riga['NomeArticolo']."</TD><TD ALIGN='center'>".$riga['NCopie']."</TD><TD ALIGN='center'>".$riga['NomeTaglia']."</TD><TD ALIGN='center'>".$riga['PrezzoArticolo']." &#8364 </TD><TD ALIGN='center'>".$riga['NomeSconto']."</TD><TD ALIGN='center'><a href='DelArticolo.php?IdCompra=".$riga['IdCompra']."'>Delete</a></TD></TR>";
						while ($riga = MySQL_fetch_array($ris))
						{
							echo "<TR><TD ALIGN='center'><a href='Articolo.php?NomeArticolo=".$riga['NomeArticolo']."'><img style='width: 100px;border: 2px dashed;' src='" . $riga['Immagine'] . "'/></a></TD><TD ALIGN='center'>".$riga['NomeArticolo']."</TD><TD ALIGN='center'>".$riga['NCopie']."</TD><TD ALIGN='center'>".$riga['NomeTaglia']."</TD><TD ALIGN='center'>".$riga['PrezzoArticolo']." &#8364 </TD><TD ALIGN='center'>".$riga['NomeSconto']."</TD><TD ALIGN='center'><a href='DelArticolo.php?IdCompra=".$riga['IdCompra']."'>Delete</a></TD></TR>";
						}
						echo  "<TR><TD>&nbsp</TD><TD>&nbsp</TD><TD>&nbsp</TD><TD>&nbsp</TD><TD>&nbsp</TD><TD>&nbsp</TD><TD ALIGN='center'><a href='ConvCarrello.php'><INPUT TYPE='button' align='right' Id='Bottone' VALUE='Buy'></a></TD></TR>";
						echo  "</TABLE>";
					}
					else
					echo "<br><br><br><h2 align='center'>Wishlist is <strong>EMPTY!</strong> </h2>";
				}
