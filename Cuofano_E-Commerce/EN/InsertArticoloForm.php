...
<div id="wrapper">
	...
	<div id="main">
		...
		<div id="content">
			...
			<TR><TD>Article</TD><TD><INPUT TYPE="text"   NAME ="NomeArticolo"></TD></TR>
			<TR><TD>Size   </TD><TD><SELECT NAME="IdTaglia">
					<OPTION VALUE=' '> </OPTION>
					<?php
					if ($db)
			...
			<TR><TD>Price</TD><TD><INPUT TYPE="text"   NAME ="PrezzoArticolo"></TD></TR>
			<TR><TD>Availability</TD><TD><INPUT TYPE="number"NAME ="NDisp"></TD></TR>
			...
			<TR><TD><input type="hidden" name="MAX_FILE_SIZE" value="3000000" />Image*</TD><TD><input name="userfile" type="file" /></TD></TR>
			...
			<TR><TD>Category   </TD><TD><SELECT NAME="IdCategoria">
					<OPTION VALUE=' '> </OPTION>
					<?php
					if ($db)
			...
			<TR><TD>Sale   </TD><TD><SELECT NAME="IdSconto">
					<OPTION VALUE=' '> </OPTION>
					<?php
					if ($db)
			...
			<TR><TD>       </TD><TD><INPUT TYPE="submit"  Id="Bottone" VALUE="Insert"></TD></TR>
			</TABLE>
			</FORM>
    	</div> <!-- #content -->
