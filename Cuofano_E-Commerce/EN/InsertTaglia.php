...
<HTML>
<HEAD>
	<TITLE>Insert Size Cuofano_ECommerce</TITLE>
	<!-- Style -->
...
<fieldset>
     ...
     <legend>Insert A New Size</legend>
	...
	<?php
		...
		{	
			...
			if ( MySQL_query ($sql) ) 
				print ("<p>Size ( ".$_REQUEST['NomeTaglia'] .") insert.</p><br>" );
		}
	    else
	...
	<a href="InsertMaterialeForm.php">Insert An Other Size</a><br>
