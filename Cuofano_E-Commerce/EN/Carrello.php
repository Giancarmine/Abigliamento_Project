			...
			{	
				...
				{	
					...
					{	
						...
						{
							echo	"<TABLE>".
									"<tr><th>Photo</th><th>Article</th><th>Quantity</th><th>Size</th><th>Price</th><th>Sale</th><th>Delete</th></tr>";
									echo "<TR><TD ALIGN='center'><a href='Articolo.php?NomeArticolo=".$riga['NomeArticolo']."'><img style='width: 100px;border: 2px dashed;' src='" . $riga['Immagine'] . "'/></a></TD><TD ALIGN='center'>".$riga['NomeArticolo']."</TD><TD ALIGN='center'>".$riga['NCopie']."</TD><TD ALIGN='center'>".$riga['NomeTaglia']."</TD><TD ALIGN='center'>".$riga['PrezzoArticolo']." &#8364 </TD><TD ALIGN='center'>".$riga['NomeSconto']."</TD><TD ALIGN='center'><a href='DelArticolo.php?Comp=1&IdCompra=".$riga['IdCompra']."'>Delete</a></TD></TR>";
							...
							echo  "<TR><TD>&nbsp</TD><TD>&nbsp</TD><TD>&nbsp</TD><TD>&nbsp</TD><TD>&nbsp</TD><TD>&nbsp</TD><TD ALIGN='center'><a href='ConvOrdini.php'><INPUT TYPE='button' align='right' Id='Bottone' VALUE='Buy'></a></TD></TR>";
							echo  "</TABLE>";
							echo  "<h2>//##ATTENTION##\\\ <br>There is NO set a metod of payment, then the request of purchase will update only the state of the Trolley.</h2>";
				...
				{
					echo "<br><br><br><h2 align='center'>Trolley is <strong>EMPTY!</strong> </h2>";
				}
			}
			?>
    	</div> <!-- #content -->
