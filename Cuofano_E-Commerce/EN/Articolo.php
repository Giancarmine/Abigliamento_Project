					...
					{	
						...
						if ($riga)
						{
							echo "<h2>". $riga['NomeCategoria'] .' '.$riga['NomeArticolo']."</h2><br>".
								 ...
								 "<TABLE>".
								 "<TR><TD>Price: </TD><TD>".$riga['PrezzoArticolo']." &#8364 </TD></TR>".
								 "<TR><TD>Sale: </TD><TD>".$riga['NomeSconto']."</TD></TR>".
								 "<TR><TD>Color: </TD><TD>".$riga['NomeColore']."</TD></TR>".
								 "<TR><TD>Size: </TD><TD>".$riga['NomeTaglia']."</TD></TR>".
								 "<TR><TD>Material: </TD><TD>".$riga['NomeMateriale']."</TD></TR>".
								 "<TR><TD>Availability: </TD><TD>".$riga['NDisp']."</TD></TR>".
								  "<TR><TD>&nbsp;</TD><TD>&nbsp;</TD></TR>";
							echo "<TR><TD>Quantity: </TD><TD><SELECT NAME='Quantita' ID='Quantita'>".
								 "<OPTION VALUE=' '> </OPTION>";
								 $N = $riga ['NDisp'];
								 for ($I = 0; $I <= $N ;$I++)
								 {	
							...
							echo "</SELECT></TD><TR><TD>Add to</TD>".
								 "<TD><INPUT TYPE='button'  Id='Bottone' VALUE='Wishlist' onclick='getListaDesideri()'></TD>".
								 "<TD><INPUT TYPE='button'  Id='Bottone' VALUE='Trolley' onclick='getCarrello()'></a></TD></TR>";
